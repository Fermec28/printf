...
int main(void)
{
	...
	printf("binary representation of 4: %s\n", number_to_string(4,2));
	printf("binary representation of 8: %s\n", number_to_string(8,2));
	printf("binary representation of 16: %s\n", number_to_string(16,2));
	printf("binary representation of 32: %s\n", number_to_string(32,2));
	printf("binary representation of 64: %s\n", number_to_string(64,2));
	printf("binary representation of 128: %s\n", number_to_string(128,2));
	printf("binary representation of 256: %s\n", number_to_string(256,2));
